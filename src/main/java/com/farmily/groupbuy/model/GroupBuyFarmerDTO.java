...
public class GroupBuyFarmerDTO {
	...
	public GroupBuyFarmerDTO(Integer groupBuyId, Integer productId, String productName, Integer groupPrice,
	        Integer hostUserId, Integer targetAmount, Timestamp openDatetime, Timestamp ddlDatetime,
	        String pickupAddress, RequestStatus requestStatus, GroupBuyStatus status,
	        Timestamp requestDatetime, Timestamp replyDatetime, String rejectReason) {
		super();
